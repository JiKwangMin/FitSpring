...
<div class="container">
<h3>관리자 답변</h3>
<form method="post" action="admin_qna_reply_ok" onsubmit="return qw_check(); ">
...
<table style="width: 100%;" class="qnatable">
 ...
 <tr>
     <th>작성자</th>
     <td><input id ="q_writer" name="q_writer" size="15px" value="관리자"></td>
 </tr>
 <tr>
    <th colspan="2">
