...
<div class="container">
	...
	<form name="myform" id="myform" method="post" action="review_edit_ok" onsubmit="return rw_check();">
		...
		<div style="float: right;">
			...
			<input class="reviewBtn" type="reset" value="취소" onclick="location='item_detail';">
