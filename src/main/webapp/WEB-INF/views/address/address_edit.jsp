                   					...
                   					<div class="content-body__corset">
									    <form action="/address/edit" method="post" class="_addressBookSaveForm" >
									    	 <div class="form-group mb-3">
										 		...
										 		<input type="text" class="form-control" name="recipientName" value="{recipientName}"/>
											 </div>
											 <div class="form-group align-items-center">
												<input class="form-control" style="width: 40%; display: inline;"
													placeholder="우편번호" name="mem_oaddress" id="mem_oaddress"
													type="text" readonly="readonly" value={우편번호}>
											...
											<div class="form-group">
												...
												readonly="readonly" value="{주소}" />
											</div>
							
											<div class="form-group">
												<input class="form-control" placeholder="상세주소"
													name="mem_detailaddress" id="mem_detailaddress" type="text" value={주소2} />
											</div>
